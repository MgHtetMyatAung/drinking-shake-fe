    ...
    <div className=" py-20">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-16 lg:gap-5">
        ...
        <div className=" ">
          ...
          <ul className=" text-gray-500 mt-3 flex flex-col gap-2">
            <li>Shop</li>
            <li>FAQ</li>
            <li>Wholesale</li>
          </ul>
        ...
        <div className="">
          ...
          <input type="email" placeholder="Your email" className=" text-sm py-3 border-b-[1px] border-gray-500 w-full focus-visible:outline-none" />
