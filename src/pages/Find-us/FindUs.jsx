...
const FindUs = () => {
  return (
    <div className="animate__animated animate__fadeIn">
      <div className="md:min-h-[50vh] relative">
        <iframe
          ...
          className=" w-full h-[40vh] md:h-[450px]"
          style={{ border: 0 }}
          allowFullScreen
          loading="lazy"
          referrerPolicy="no-referrer-when-downgrade"
        />
        <div className="flex items-center absolute top-[28%] md:top-[10%] right-[10%] bg-white rounded-lg overflow-hidden shadow-lg">
          <input
            type="text"
