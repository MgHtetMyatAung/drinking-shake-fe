...
const SignUp = () => {
  ...
  return (
    <div className="flex min-h-screen flex-1 flex-col justify-center px-6 py-12 lg:px-8">
      <button className=" absolute top-8 md:top-10 left-5 md:left-20 flex items-center gap-3 md:gap-5 active:gap-2 transition-all duration-200" onClick={()=>navigate("/login")}>
        <BiChevronsLeft size={20}/> Back
      </button>
